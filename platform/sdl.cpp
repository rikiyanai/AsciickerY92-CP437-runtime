// =============================================================================
// SDL2 Platform Backend — Cross-Platform Windowing & Input
// =============================================================================
//
// PLATFORM TARGET:
// Windows, Linux, macOS — any OS with SDL2 support
// Compile flag: USE_SDL
...
// - Web support: can be compiled with Emscripten for WebGL
//
...
//
// INTEGRATION POINTS:
// - platform.h      — Implements PlatformInterface contract (callbacks for input/render)
...
//
// KEY FILES:
// - sdl.cpp         — This file: SDL2 backend implementation
// - platform.h      — Contract definition (PlatformInterface, KeyInfo, MouseInfo)
