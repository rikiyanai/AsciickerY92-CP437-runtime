...
> Historical upstream documentation preserved for provenance. Its regeneration
> commands require the excluded parent repository; the standalone runtime does
> not claim those commands are runnable here.
