...
print("RENDER tab", send("FL4260_FOCUS_SIDEBAR_TAB","9")[-40:].replace("\n"," "))
time.sleep(0.4)
print("select mat", send("FL4260_RENDERING_PROOF","4 -1 0")[-40:].replace("\n"," "))
time.sleep(0.4)
print("scroll top", send("FL4260_SCROLL_Y","0")[-40:].replace("\n"," "))
time.sleep(0.5)
d="/tmp/palette_render_tab"; os.makedirs(d,exist_ok=True)
